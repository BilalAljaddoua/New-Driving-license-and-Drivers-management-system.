    ...
    public partial class frmAddUpdateLocalDrivingLicesnseApplication: Form
    {
        ...
        private void _ResetDefualtValues()
        {
            ...
            if (_Mode == enMode.AddNew)
            {
                ...
                lblFees.Text = clsApplicationType.FindApplicationType(clsApplication.enApplicationType.NewLocalDrivingLicense).Fees.ToString();  
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
         ...
         //   check if user already have issued license of the same driving  class.
            if( clsLicense.IsLicenseExists(ctrlPersonCardWithFilter1.PersonID, LicenseClassID)!=-1)           
             {
            ...
            _LocalDrivingLicenseApplication.ApplicationTypeID = clsApplication.enApplicationType.NewLocalDrivingLicense;
