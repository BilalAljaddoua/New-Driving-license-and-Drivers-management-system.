...
{
    public partial class frmListLicensesDetaied : Form
    {
        private DataTable _dtDetainedLicenses;

        public frmListLicensesDetaied()
        {
            InitializeComponent();
        }

        private void frmListLicensesDetaied_Load(object sender, EventArgs e)
        {
        ...
        private void showPersonLicenseHistoryToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            int PersonID = clsLicense.FindLicensesByLicenseID(LicenseID).DriverInfo.PersonID;
        ...
        private void btnDetainLicense_Click(object sender, EventArgs e)
        {
            ...
            frm.ShowDialog();
            //refresh
            frmListLicensesDetaied_Load(null, null);
        ...
        {
            int id = clsLicense.FindLicensesByLicenseID((int)dgvDetainedLicenses.CurrentRow.Cells[1].Value).PersonInfo.PersonID;
