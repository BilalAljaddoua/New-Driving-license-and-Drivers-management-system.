...
namespace DVLD.Tests
{
    public partial class frmListTestAppointments: Form
    {
        ...
        private void frmListTestAppointments_Load(object sender, EventArgs e)
        {
            ...
            _dtLicenseTestAppointments = clsTestAppointment.GetAllTestsByLDLAppAndTestType(_LocalDrivingLicenseApplicationID,_TestType);
            ...
            if (dgvLicenseTestAppointments.Rows.Count>0)
            {
                ...
                dgvLicenseTestAppointments.Columns[1].HeaderText = "Paid Fees";
                dgvLicenseTestAppointments.Columns[1].Width = 150;

                dgvLicenseTestAppointments.Columns[2].HeaderText = "Appointment Date";
                dgvLicenseTestAppointments.Columns[2].Width = 200;

                dgvLicenseTestAppointments.Columns[3].HeaderText = "By User";
        ...
        private void btnAddNewAppointment_Click(object sender, EventArgs e)
        {
            ...
            if (localDrivingLicenseApplication.IsThereAnActiveSchudleTest(_TestType))
            {
            ...
            clsTest LastTest=localDrivingLicenseApplication.GetLastTestPerTestType((int) _TestType);
